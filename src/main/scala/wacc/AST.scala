...
object AST {
  ...
  case class Program(val functions: List[Func], val statements: List[Statement])(val pos: (Int, Int))
  case class Func(identBinding: IdentBinding, params: List[Parameter], body: List[Statement])(val pos: (Int, Int))
  case class Parameter(typeName: Type, identifier: Identifier)(val pos: (Int, Int))
  case class IdentBinding(typeName: Type, identifier: Identifier)(val pos: (Int, Int))

  sealed trait Statement
  case class DeclarationStatement(typeName: Type, val identifier: Identifier, rvalue: RValue)(val pos: (Int, Int)) extends Statement
  case class AssignmentStatement(lvalue: LValue, rvalue: RValue)(val pos: (Int, Int)) extends Statement
  case class ReadStatement(lvalue: LValue)(val pos: (Int, Int)) extends Statement
  case class FreeStatement(expression: Expression)(val pos: (Int, Int)) extends Statement
  case class ReturnStatement(expression: Expression)(val pos: (Int, Int)) extends Statement
  case class ExitStatement(expression: Expression)(val pos: (Int, Int)) extends Statement
  case class PrintStatement(expression: Expression)(val pos: (Int, Int)) extends Statement
  case class PrintLnStatement(expression: Expression)(val pos: (Int, Int)) extends Statement
  case class IfStatement(condition: Expression, thenStatement: List[Statement], elseStatement: List[Statement])(val pos: (Int, Int)) extends Statement
  case class WhileStatement(condition: Expression, doStatement: List[Statement])(val pos: (Int, Int)) extends Statement
  case class BeginStatement(statement: List[Statement])(val pos: (Int, Int)) extends Statement
  ...
  sealed trait LValue
  case class Identifier(name: String)(val pos: (Int, Int)) extends LValue with Expression
  case class PairElem(index: PairIndex, value: LValue)(val pos: (Int, Int)) extends LValue with RValue
  case class ArrayElem(identifier: Identifier, indices: List[Expression])(val pos: (Int, Int)) extends LValue with Expression
  ...
  case class ArrayType(arrayType: Type, arity: Int)(val pos: (Int, Int)) extends Type with PairElemType
  ...
  sealed trait RValue
  case class NewPair(fst: Expression, snd: Expression)(val pos: (Int, Int)) extends RValue
  case class ArrayLiteral(expressions: List[Expression])(val pos: (Int, Int)) extends RValue
  case class FunctionCall(identifier: Identifier, args: List[Expression])(val pos: (Int, Int)) extends RValue
  ...
  // Bridges
  object Program extends ParserBridgePos2[List[Func], List[Statement], Program]
  object Func extends ParserBridgePos3[IdentBinding, List[Parameter], List[Statement], Func] {
  ...
  object DeclarationStatement extends Statement with ParserBridgePos3[Type, Identifier, RValue, DeclarationStatement]
  object AssignmentStatement extends Statement with ParserBridgePos2[LValue, RValue, AssignmentStatement]
  object ReadStatement extends Statement with ParserBridgePos1[LValue, ReadStatement]
  object FreeStatement extends Statement with ParserBridgePos1[Expression, FreeStatement]
  object ReturnStatement extends Statement with ParserBridgePos1[Expression, ReturnStatement]
  object ExitStatement extends Statement with ParserBridgePos1[Expression, ExitStatement]
  object PrintStatement extends Statement with ParserBridgePos1[Expression, PrintStatement]
  object PrintLnStatement extends Statement with ParserBridgePos1[Expression, PrintLnStatement]
  object IfStatement extends Statement with ParserBridgePos3[Expression, List[Statement], List[Statement], IfStatement]
  object WhileStatement extends Statement with ParserBridgePos2[Expression, List[Statement], WhileStatement]
  object BeginStatement extends Statement with ParserBridgePos1[List[Statement], Statement]

  object Identifier extends LValue with Expression with ParserBridgePos1[String, Identifier]
  object IdentBinding extends ParserBridgePos2[Type, Identifier, IdentBinding]
  object PairElem extends LValue with RValue with ParserBridgePos2[PairIndex, LValue, LValue with RValue]
  object ArrayElem extends LValue with Expression with ParserBridgePos2[Identifier, List[Expression], LValue with Expression]
  object IdentOrArrayElem extends ParserBridgePos2[String, List[Expression], LValue with Expression] {
    def apply(ident: String, exprs: List[Expression])(pos: (Int, Int)) = exprs match {
  ...
  object PairType extends Type with ParserBridgePos2[PairElemType, PairElemType, PairType]

  object NewPair extends RValue with ParserBridgePos2[Expression, Expression, RValue]
  object ArrayLiteral extends RValue with ParserBridgePos1[List[Expression], RValue]
  object FunctionCall extends RValue with ParserBridgePos2[Identifier, List[Expression], RValue]
